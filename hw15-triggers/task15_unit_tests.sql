...
Begin 
    ...
    raise_application_error(-20999, 'Unit-тест, или API выполнены неверно');
Exception 
    when payment_api_pack.invalid_delete_forbidden then 
...
Begin 
    ...
    raise_application_error(-20999, 'Unit-тест, или API выполнены неверно');
Exception 
    when payment_api_pack.invalid_manual_changes then 
...
--Проверка на вставку данных длатежа (Payment_detail) не через API
...
Begin 
    ...
    raise_application_error(-20999, 'Unit-тест, или API выполнены неверно');
Exception 
    when payment_detail_api_pack.invalid_manual_changes then 
...
--Проверка на обновление данных длатежа (Payment_detail) не через API
...
--Проверка на удаление данных длатежа (Payment_detail) не через API
